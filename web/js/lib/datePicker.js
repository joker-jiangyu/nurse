...
window.datePicker = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            if(params.isClear == 'true') isClear = '';
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalender_clear"><div '+isClear+'><i class="fa fa-refresh"></i></div></div>' +
                    '<div class="date_btn lcalendar_cancel"><i class="fa fa-chevron-down" ></i></div>' +
                ...
                var lcalender_clear = _self.gearDate.querySelector(".lcalender_clear");
                lcalender_clear.addEventListener('touchstart', clearValue);
                ...
                lcalender_clear.addEventListener('click', clearValue);
            ...
            function clearValue(e){
                e.preventDefault();
                if(_self.onClear) _self.onClear();
                if(e != undefined)
            ...
            //移动结束 赋值 不关闭
            function finishMobileNotClose() {
                if(pickerType == "ym"){//年月
                    finishMobileYM();
                }else if(pickerType == "date"){//年月日
                    finishMobileDate();
                }else if(pickerType == "datetime"){//年月日时分秒
            ...
            function clickOthers(){
                $(document).bind("click", function (e) {
                    ...
                    if (target.closest(".gearDate").length == 0) {
                        $(".gearDate").remove();
                    }
                    if (target.closest(".gearDate").length == 0) {
                        $(".gearDate").remove();
