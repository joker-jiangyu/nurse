			...
			function($stateProvider, $urlRouterProvider, plUploadServiceProvider) {
				...
				$stateProvider
					.state("home", {
						...
						views: {
							'container': {
								templateUrl: 'partials/iViewHome.html'
							}
						}
					})
					.state('alarm', {
						...
						views: {
							'container': {
								templateUrl: 'partials/iViewAlarm.html'
							}
						}
					})
					...
					.state('alarmrecord', {
						...
						views: {
							'container': {
								templateUrl: 'partials/iViewAlarmRecord.html'
							}
						}
					})
					.state('signalrecord', {
						...
						views: {
							'container': {
								templateUrl: 'partials/iViewSignalRecord.html'
							}
						}
					})
                    .state('cardsrecord', {
                    ...
                    .state('userOperationRecord', {
                        ...
                        views: {
                            'container': {
                                templateUrl: 'partials/iViewOperationRecord.html'
                            }
                        }
                    })
					.state('otherModule', {
					...
					.state('astructure', {
						url: '/astructure/{deviceBaseTypeId:int}',
						params: {
							'diagramview': 'structure'
						},
						views: {
							'container': {
								templateUrl: 'partials/astructure.html'
							}
						}
					})
					.state('setting', {
